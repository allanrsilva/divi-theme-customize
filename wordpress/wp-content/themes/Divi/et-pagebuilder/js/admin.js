		...
		ET_PageBuilder.Layout = Backbone.Model.extend( {
			...
			defaults: {
				...
				modules : [
					...
					{
						'title' : 'Fullwidth Slider - Artezzo',
						'label' : 'etet_pb_fullwidth_slider_artezzo|_pb_fullwidth_slider_artezzo',
						'fullwidth_only' : 'on'
					},
